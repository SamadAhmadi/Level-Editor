...
int main(int, char**)
{
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        // Tip: if we don't call ImGui::Begin()/ImGui::End() the widgets appears in a window automatically called "Debug"
        {
            ...
            if (ImGui::Button("Window2")) show_another_window ^= 1;
			if (ImGui::Button("Window3")) window1 ^= 1;
		...
		if (window1)
		{
			...
			static float vec3a[3] = {0.0f, 0.0f, 2.0f};
			...
			ImGui::Text(" ");
			ImGui::InputFloat3("Pos", vec3a);
			ImGui::Text(" ");
			ImGui::SliderFloat("Width", &W, 0.01f, 10.0f);
			ImGui::SliderFloat("Height", &H, 0.01f, 10.0f);
			ImGui::SliderFloat("Depth", &D, 0.01f, 10.0f);
			ImGui::SliderFloat("Rotation", &R, 0.0f, 360.0f);
			ImGui::Text(" ");
